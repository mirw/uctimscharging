...
/** list of peers */
typedef struct {
	peer *head;	/**< first peer in the list */	//peer.h
	peer *tail; /**< last peer in the list */
} peer_list_t;

int peer_manager_init(dp_config *config); //config.h
...
AAAMsgIdentifier next_hopbyhop(); //diameter.h
AAAMsgIdentifier next_endtoend();  //diameter.h
