...
#define u_TIMER_RESOLUTION 1000 /**Number of microseconds to wait **/
...
{
	time_t now;
	//struct timeval start_time, result_time, end_time, temp_start_time, temp_end_time;
	//int uend_time, u_temp_start_time, u_temp_end_time;
	timer_cb_t *i;
	callback_f cb=0;
	void *ptr=0;
