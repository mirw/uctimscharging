/**
 * $Id: diameter_ims.h 550 2008-04-13 10:10:56Z albertoberlios $
 *  
...
/* newly defined for r7 charging architecture*/
/* The Rf interface */
#define IMS_ACR     271     /**< Accounting Request         Request */
#define IMS_ACA     271     /**< Accounting Answer          Answer  */  
/* the Ro interface */
/* The Gx Interface */
#define IMS_CCR		272
#define IMS_CCA		272
/* end of newly defined    */
 ...
 *									*/
 ...
 /** 1000   from TS29.212 */
	...
	/*added by me - checked with 3gpp*/
	AVP_Accounting_Record_Type        =  480,
	AVP_Accounting_Record_Number	  =  485,
	AVP_Service_context_Id		  =  402,
	AVP_CC_Request_Type		  =  416,
	AVP_CC_Request_Number		  =  417,  /** its not real, not yet assigned*/

	/****Custom AVP code - not yet assigned, Added by Vitalis***/
	AVP_Call_Record_Id		=  420,
	AVP_Credit_onceoff		=  421,
	AVP_Credit_persec		=  422,
	AVP_Credit_perMbyte		=  423,
	AVP_Subscriber			=  424,	
