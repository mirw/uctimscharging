...
/**
 * Creates and adds an Origin Host AVP.
 * @param msg - the Diameter message to add to.
 * @param data - the value for the AVP payload
 * @returns 1 on success or 0 on error
 */
 ...
 * Creates and adds a Session ID AVP.
 * @param msg - the Diameter message to add to.
 * @param data - the value for the AVP result code number
 * @returns 1 on success or 0 on error
 */
inline int Ro_add_result_code(AAAMessage *msg, unsigned int data)
{
	char x[4];
	set_4bytes(x,data);
	return 
...
/**
 * Creates and adds a Credit Control Type AVP.
 * @param msg - the Diameter message to add to.
 * @param data - the value for the AVP payload
 * @returns 1 on success or 0 on error
 */
 ...
 * @returns 1 on success or 0 on error
 */
inline int Ro_add_vendor_specific_appid(AAAMessage *msg,unsigned int vendor_id,
	unsigned int auth_id,unsigned int acct_id)
{
	...
	return 
	Ro_add_avp(msg,group.s,group.len,
